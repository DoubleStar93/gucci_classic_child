...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.3', '/home/customer/www/barbaraalvisi.it/public_html', false);
    }
    ...
    {
        return $container->services['PsCheckout\\Cache\\FileSystem\\PayPalOrder'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('paypal-orders', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.3', '/home/customer/www/barbaraalvisi.it/public_html', false))->getPath());
    }
    ...
    {
        return $container->services['PsCheckout\\Cache\\FileSystem\\ShippingTracking'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('shipping-tracking', 3600, ($container->services['PrestaShop\\ModuleLibCacheDirectoryProvider\\Cache\\CacheDirectoryProvider'] ??= new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('9.0.3', '/home/customer/www/barbaraalvisi.it/public_html', false))->getPath());
    }
    ...
    {
        return $container->services['PsCheckout\\Core\\Order\\Builder\\Node\\CardPaymentSourceNodeBuilder'] = new \PsCheckout\Core\Order\Builder\Node\CardPaymentSourceNodeBuilder(($container->services['PsCheckout\\Core\\Settings\\Configuration\\PayPalConfiguration'] ?? self::getPayPalConfigurationService($container)), ($container->services['PsCheckout\\Infrastructure\\Repository\\CountryRepository'] ?? self::getCountryRepository2Service($container)), ($container->services['PsCheckout\\Infrastructure\\Repository\\StateRepository'] ??= new \PsCheckout\Infrastructure\Repository\StateRepository()), ($container->services['PsCheckout\\Infrastructure\\Adapter\\Link'] ?? self::getLinkService($container)));
    }
    ...
    {
        return $container->services['PsCheckout\\Core\\Order\\Builder\\Node\\PaymentSource\\BancontactPaymentSourceNodeBuilder'] = new \PsCheckout\Core\Order\Builder\Node\PaymentSource\BancontactPaymentSourceNodeBuilder(($container->services['PsCheckout\\Infrastructure\\Adapter\\Configuration'] ?? self::getConfiguration2Service($container)), ($container->services['PsCheckout\\Infrastructure\\Adapter\\Link'] ?? self::getLinkService($container)), ($container->services['PsCheckout\\Infrastructure\\Repository\\CountryRepository'] ?? self::getCountryRepository2Service($container)));
    }
    ...
    {
        return $container->services['PsCheckout\\Core\\Order\\Builder\\Node\\PaymentSource\\EpsPaymentSourceNodeBuilder'] = new \PsCheckout\Core\Order\Builder\Node\PaymentSource\EpsPaymentSourceNodeBuilder(($container->services['PsCheckout\\Infrastructure\\Adapter\\Configuration'] ?? self::getConfiguration2Service($container)), ($container->services['PsCheckout\\Infrastructure\\Adapter\\Link'] ?? self::getLinkService($container)), ($container->services['PsCheckout\\Infrastructure\\Repository\\CountryRepository'] ?? self::getCountryRepository2Service($container)));
    }
    ...
    {
        return $container->services['PsCheckout\\Core\\Order\\Builder\\Node\\PaymentSource\\IdealPaymentSourceNodeBuilder'] = new \PsCheckout\Core\Order\Builder\Node\PaymentSource\IdealPaymentSourceNodeBuilder(($container->services['PsCheckout\\Infrastructure\\Adapter\\Configuration'] ?? self::getConfiguration2Service($container)), ($container->services['PsCheckout\\Infrastructure\\Adapter\\Link'] ?? self::getLinkService($container)), ($container->services['PsCheckout\\Infrastructure\\Repository\\CountryRepository'] ?? self::getCountryRepository2Service($container)));
    }
    ...
    {
        return $container->services['PsCheckout\\Core\\Order\\Builder\\Node\\PaymentSource\\P24PaymentSourceNodeBuilder'] = new \PsCheckout\Core\Order\Builder\Node\PaymentSource\P24PaymentSourceNodeBuilder(($container->services['PsCheckout\\Infrastructure\\Adapter\\Configuration'] ?? self::getConfiguration2Service($container)), ($container->services['PsCheckout\\Infrastructure\\Adapter\\Link'] ?? self::getLinkService($container)), ($container->services['PsCheckout\\Infrastructure\\Repository\\CountryRepository'] ?? self::getCountryRepository2Service($container)));
    }
    ...
    {
        return $container->services['PsCheckout\\Core\\Order\\Builder\\Node\\PaymentSource\\VenmoPaymentSourceNodeBuilder'] = new \PsCheckout\Core\Order\Builder\Node\PaymentSource\VenmoPaymentSourceNodeBuilder(($container->services['PsCheckout\\Infrastructure\\Adapter\\Configuration'] ?? self::getConfiguration2Service($container)));
    }
    ...
    {
        return $container->services['prestashop.adapter.employee_language_updater'] = new \PrestaShop\PrestaShop\Adapter\Employee\EmployeeLanguageUpdater(($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'jkrc_', ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PS_LANG_DEFAULT"));
    }
    ...
    {
        return $container->services['prestashop.adapter.module.repository.module_repository'] = new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('/home/customer/www/barbaraalvisi.it/public_html', '/home/customer/www/barbaraalvisi.it/public_html/modules/');
    }
    ...
    {
        return $container->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, '/home/customer/www/barbaraalvisi.it/public_html/var/cache/prod//localization');
    }
    ...
    {
        return $container->services['prestashop.database.naming_strategy'] = new \PrestaShopBundle\Service\Database\DoctrineNamingStrategy(($container->services['annotation_reader'] ??= new \Doctrine\Common\Annotations\AnnotationReader()), 'jkrc_');
    }
    ...
    {
        return $container->services['prestashop.translation.translator_language_loader'] = new \PrestaShopBundle\Translation\TranslatorLanguageLoader(($container->services['prestashop.adapter.module.repository.module_repository'] ??= new \PrestaShop\PrestaShop\Adapter\Module\Repository\ModuleRepository('/home/customer/www/barbaraalvisi.it/public_html', '/home/customer/www/barbaraalvisi.it/public_html/modules/')));
    }
    ...
    {
        return $container->services['product_comment_criterion_repository'] = new \PrestaShop\Module\ProductComment\Repository\ProductCommentCriterionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'jkrc_');
    }
    ...
    {
        return $container->services['product_comment_repository'] = new \PrestaShop\Module\ProductComment\Repository\ProductCommentRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->services['doctrine.dbal.default_connection'] ?? self::getDoctrine_Dbal_DefaultConnectionService($container)), 'jkrc_', ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PRODUCT_COMMENTS_ALLOW_GUESTS"), ($container->services['PrestaShop\\PrestaShop\\Adapter\\Configuration'] ??= new \PrestaShop\PrestaShop\Adapter\Configuration())->get("PRODUCT_COMMENTS_MINIMAL_TIME"));
    }
    ...
    protected static function getDotEnvLayerService($container, $lazyLoad = true)
    {
        ...
        return ($lazyLoad->__construct(($container->services['prestashop.adapter.environment'] ??= new \PrestaShop\PrestaShop\Adapter\Environment(false, 'prod', 'front')), '/home/customer/www/barbaraalvisi.it/public_html') && false ?: $lazyLoad);
    }
    ...
    protected static function getDoctrine_Orm_DefaultConfigurationService($container)
    {
        ...
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['/home/customer/www/barbaraalvisi.it/public_html/src/PrestaShopBundle/Entity']), 'PrestaShop');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['/home/customer/www/barbaraalvisi.it/public_html/modules/ps_checkout/src/Entity']), 'PrestaShop\\Module\\PrestashopCheckout\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['/home/customer/www/barbaraalvisi.it/public_html/modules/ps_accounts/src/Entity']), 'PrestaShop\\Module\\PsAccounts\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['/home/customer/www/barbaraalvisi.it/public_html/modules/psshipping/src/Entity']), 'PrestaShop\\Module\\Psshipping\\Entity');
        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, ['/home/customer/www/barbaraalvisi.it/public_html/modules/productcomments/src/Entity']), 'PrestaShop\\Module\\ProductComment\\Entity');
        ...
        $instance->setProxyDir('/home/customer/www/barbaraalvisi.it/public_html/var/cache/prod//doctrine/orm/Proxies');
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'database_port' => '',
            'database_name' => 'dbkog5oycwsri7',
            'database_user' => 'ufcauakc9qesv',
            'database_password' => 'Rjgifkc6!',
            'database_prefix' => 'jkrc_',
            'database_engine' => 'InnoDB',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => NULL,
            'mailer_password' => NULL,
            'secret' => 'AwmYWHCAQyys2qPePcKcfV9LcwnZzIb50zff8VE5f2ddA1nI73V0UMpyEA1OjbTz',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2026-05-22',
            'locale' => 'en-US',
            ...
            'api_public_key' => '-----BEGIN PUBLIC KEY-----'."\n".'MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAwHWhyUaFmdBB9s/EEVIp'."\n".'thq9mQk548bYbvm4pSSJFTnQhst+9UEnarJPwjHti1mePt9nP7NusMHUAJA7jvQv'."\n".'r+XHSqtCklKpvxaKxOZsQY+b03jRe/WrE+Bb9jIruIuxwN9kklwkbXsEip8rreAj'."\n".'+HG0HgZRGjP++QeTe77xalbGuLjNY0ENACCocsUeBEZrG9Es5/RXB4detRdPc9D2'."\n".'7bIn54OxJlx/YN7IyDKcSwzZDE6gaYHjA/vTyW8wnkAP5TZm/fLrZ7b6ogDASmMj'."\n".'tShCcVeDQiIu4Ocp5n/BGekP/h1CKzUt4RS2PiGWKGINxKy0xsqBjbYshbA7Tlh1'."\n".'2QIDAQAB'."\n".'-----END PUBLIC KEY-----'."\n".'',
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvQIBADANBgkqhkiG9w0BAQEFAASCBKcwggSjAgEAAoIBAQDAdaHJRoWZ0EH2'."\n".'z8QRUim2Gr2ZCTnjxthu+bilJIkVOdCGy371QSdqsk/CMe2LWZ4+32c/s26wwdQA'."\n".'kDuO9C+v5cdKq0KSUqm/ForE5mxBj5vTeNF79asT4Fv2Miu4i7HA32SSXCRtewSK'."\n".'nyut4CP4cbQeBlEaM/75B5N7vvFqVsa4uM1jQQ0AIKhyxR4ERmsb0Szn9FcHh161'."\n".'F09z0Pbtsifng7EmXH9g3sjIMpxLDNkMTqBpgeMD+9PJbzCeQA/lNmb98utntvqi'."\n".'AMBKYyO1KEJxV4NCIi7g5ynmf8EZ6Q/+HUIrNS3hFLY+IZYoYg3ErLTGyoGNtiyF'."\n".'sDtOWHXZAgMBAAECggEASXxAz4j5Vz8hCLvQ+eoc2hcAwM+4hmO03T7FhWzbWLrw'."\n".'B5/otH1xrvgxow0MTfJkjU4g7r407BG+QI7R5uYO1UNPoo+cxiEBBmD1kHQI7smG'."\n".'LqtJlWK6tUar5mfGsNrJ/sJtdMLw98qKc+GNvIDCS0kjBHnV+sLSvsRpSE0igb7B'."\n".'zcKpktPrLIJHzIMwhF6OgBOYS420p8Cp7FsWvyyUwq7ieNvVh5AXoreqjz0iwbH8'."\n".'wfOI11jk2kwdjpZhlUDgsDMN9g0xChOIm0s8no9L/wDFapTbFRLJYmSohu58HvPQ'."\n".'Bh/OXT86h5JYTdAHfhukaqL/1GQ3garh6J5RShaSZwKBgQDnntIvt89yIrRel89Z'."\n".'+9OU3nR0AnWpFtDO2ebOSp5T3s6GeZ1itDEZkau6MFI68hKBIYYJ8Rnw5hfDakJd'."\n".'e3uOrEaCyUFVuDwyVXo8rQkv4/L/AnYea1NxC4n7WQc7Ob6/OI9MZEHW1J3Nz0EH'."\n".'3J6aiotXX1mXEtjwhUGl6TXkrwKBgQDUt5eiSKDqUzdSmWtQA8XFU9eta+wM448H'."\n".'qf3Oi8TxPG2huoWmogf3xKi4C5Hkjx/0traIhG3wUHMjKbTlt8nz+x9js25lTvCa'."\n".'l2H8x8CG2v7s8R2VKwvAOGyiulny7ASTbFzYF9iqpfexw/RqPh//v68JGgma/wQs'."\n".'8Us2hPp/9wKBgCdpzzpvfM1fOnIeQxp8z7Q1ZnuXL45mY4HPcocIC4kaEOqxJyb0'."\n".'oqZHM4GrV1LQfnWazsRCUre7b6/BFSnzKUNN7XGz7Xo4r4WhJfvNNhMAJwld0du7'."\n".'R6ek3wX2UFSzrtG7PicxqEJ2S6QJ8Hb2A8cobC2h/AzJGEFVa6Zf2NvhAoGBAMuL'."\n".'bh6MruXqgRqZ0bT8FyfOJag9h9+BdGDaChK1bduEfkduius7SrKMzQFnmNADIIny'."\n".'uFGDnwuAf9wa0Y2rQyUinBO0I6PvWI4k40+V+KVSMvOZeTw+t3zUwScpeF7Z9zr2'."\n".'SxVAJESOkajZoCx1i/sWebAU6TIWafFzZwwhTO5bAoGAIazvlxi0Jk8V8DugvzRe'."\n".'GX5zU4d9MuzV6Z1fffb0zw+WYXEBc2kwa2Uui7V7LQHPlNKHyKbTq/YljTSPkX8V'."\n".'k+otcNi36/4+p7Tvckr6RdQCe28wwC2cZmZ6KrbzNXc6iqu1jfcwIpYvnTPNGEFr'."\n".'MYegHlCqy3aiUbaOUzPHnIg='."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'kernel.app_id' => 'front',
            'kernel.cache_dir' => '/home/customer/www/barbaraalvisi.it/public_html/var/cache/prod/',
            'kernel.active_modules' => [
                0 => 'gsitemap',
                1 => 'ps_checkout',
                2 => 'ps_faviconnotificationbo',
                3 => 'ps_crossselling',
                ...
                48 => 'everpspopup',
                49 => 'ps_facebook',
                50 => 'ps_customersignin',
                51 => 'ps_facetedsearch',
                52 => 'ps_currencyselector',
                ...
                66 => 'statsstock',
                67 => 'dashactivity',
                68 => 'ps_languageselector',
                69 => 'ps_brandlist',
                70 => 'statsnewsletter',
                71 => 'blockwishlist',
                72 => 'statsbestcategories',
                73 => 'statscheckup',
                74 => 'productcomments',
            ],
            ...
            'prestashop.installed_modules' => [
                ...
                61 => 'ps_classic_edition',
                62 => 'ps_specials',
                63 => 'psshipping',
                64 => 'paypal',
                65 => 'statsbestproducts',
                66 => 'ps_categorytree',
                67 => 'statsstock',
                68 => 'dashactivity',
            ...
            'prestashop.module_dir' => '/home/customer/www/barbaraalvisi.it/public_html/modules/',
            'kernel.project_dir' => '/home/customer/www/barbaraalvisi.it/public_html',
            'ps_cache_dir' => '/home/customer/www/barbaraalvisi.it/public_html/var/cache/prod/',
            ...
            'doctrine.orm.proxy_dir' => '/home/customer/www/barbaraalvisi.it/public_html/var/cache/prod//doctrine/orm/Proxies',

...
{block name='page_content'}
  <div class="gucci-orders-page gucci-page-content">
    <p class="gucci-orders-intro">
            ...
            {foreach from=$orders item=order}
              <tr>
                ...
                <td class="text-xs-center order-actions">
                  <a href="{$order.details.details_url}" data-link-action="view-order-details" class="gucci-btn gucci-btn--outline gucci-btn--sm">
                    {if $language.iso_code == 'it'}Dettagli{else}{l s='Details' d='Shop.Theme.Customeraccount'}{/if}
                  </a>
                  {if $order.details.reorder_url}
                    <a href="{$order.details.reorder_url}" class="gucci-btn gucci-btn--outline gucci-btn--sm">

{**
 * Barbara Alvisi — form contatti minimal
 *}
<section class="contact-form barbaraalvisi-contact-form">
  <form action="{$urls.pages.contact|escape:'htmlall':'UTF-8'}" method="post" {if $contact.allow_file_upload}enctype="multipart/form-data"{/if}>
    {if $notifications}
      <div class="alert {if $notifications.nw_error}alert-danger{else}alert-success{/if} barbaraalvisi-contact-alert">
        <ul>
    ...
    {if !$notifications || $notifications.nw_error}
      <div class="form-fields barbaraalvisi-contact-fields">
        ...
        {else}
          <div class="form-group barbaraalvisi-form-group">
        ...
        {if $contact.orders}
          <div class="form-group barbaraalvisi-form-group">
            <label class="form-control-label" for="id-order">
              ...
              <span class="barbaraalvisi-form-optional">{if $language.iso_code == 'it'}(facoltativo){else}{l s='optional' d='Shop.Forms.Help'}{/if}</span>
            </label>
        ...
        {if $contact.allow_file_upload}
          <div class="form-group barbaraalvisi-form-group barbaraalvisi-form-group--file">
            ...
            <div class="barbaraalvisi-file-upload">
              <input id="file-upload" type="file" name="fileUpload" class="form-control barbaraalvisi-file-upload__input">
              <button type="button" class="barbaraalvisi-file-upload__trigger" data-barbaraalvisi-file-trigger>
                {if $language.iso_code == 'it'}Scegli file{else}{l s='Choose file' d='Shop.Theme.Actions'}{/if}
              </button>
              <span class="barbaraalvisi-file-upload__name" data-barbaraalvisi-file-name aria-live="polite">
        ...
        {if isset($id_module)}
          <div class="form-group barbaraalvisi-form-group barbaraalvisi-form-group--gdpr">
            {hook h='displayGDPRConsent' id_module=$id_module}
          </div>
        {/if}
      </div>

      <footer class="form-footer barbaraalvisi-contact-footer">
        <input type="text" name="url" value="" tabindex="-1" autocomplete="off" aria-hidden="true" class="barbaraalvisi-honeypot">
        <input type="hidden" name="token" value="{$token|escape:'htmlall':'UTF-8'}">
        <button class="btn btn-primary barbaraalvisi-btn barbaraalvisi-btn--primary" type="submit" name="submitMessage">

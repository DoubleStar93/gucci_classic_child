{**
 * Barbara Alvisi — più venduti (home: 4 prodotti)
 *}
{if $products|count}
  {if $language.iso_code == 'it'}
    {assign var='barbaraalvisiSectionTitle' value='I più venduti'}
    {assign var='barbaraalvisiSectionLinkLabel' value='Vedi tutto'}
  {else}
    {assign var='barbaraalvisiSectionTitle' value='Best sellers'}
    {assign var='barbaraalvisiSectionLinkLabel' value='View all'}
  {/if}
  {assign var='barbaraalvisiAllProductsLink' value=$link->getPageLink('best-sales')}
  {if $products|@count > 4}
    {assign var='barbaraalvisiHomeProducts' value=$products|array_slice:0:4}
  {else}
    {assign var='barbaraalvisiHomeProducts' value=$products}
  {/if}
  <section class="featured-products barbaraalvisi-home-section barbaraalvisi-home-section--products clearfix" data-type="bestsellers">

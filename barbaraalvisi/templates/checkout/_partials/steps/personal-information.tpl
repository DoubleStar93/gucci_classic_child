{**
 * Barbara Alvisi — step informazioni personali checkout (IT + tab minimal)
 *}
...
{block name='step_content'}
  ...
  {if $customer.is_logged && !$customer.is_guest}
    <p class="barbaraalvisi-checkout-logged-as">
    ...
    <p class="barbaraalvisi-checkout-logout-link">
      <a href="{$urls.actions.logout}" class="barbaraalvisi-checkout-link">
    ...
    {if !isset($empty_cart_on_logout) || $empty_cart_on_logout}
      <p class="barbaraalvisi-checkout-logout-note">
    ...
    <p class="barbaraalvisi-checkout-continue-wrap">
      <button type="button" class="barbaraalvisi-btn barbaraalvisi-btn--primary continue btn btn-primary" name="continue" data-link-action="register-new-customer">
        {if $language.iso_code == 'it'}Continua{else}{l s='Continue' d='Shop.Theme.Actions'}{/if}
      </button>
    </p>
  {else}
    <ul class="nav nav-tabs barbaraalvisi-checkout-tabs" role="tablist">
      <li class="nav-item">
        <a
    ...
    <div class="tab-content barbaraalvisi-checkout-tab-panels">

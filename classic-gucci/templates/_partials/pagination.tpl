 ...
 *}
<nav class="pagination gucci-pagination" aria-label="{if $language.iso_code == 'it'}Paginazione{else}{l s='Pagination' d='Shop.Theme.Global'}{/if}">
  <div class="gucci-pagination__inner">
    <p class="gucci-pagination__summary">
    ...
    {block name='pagination_page_list'}
      {if $pagination.should_be_displayed}
        <ul class="page-list gucci-pagination__pages">

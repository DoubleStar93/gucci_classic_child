{**
 * Classic Gucci — card marchio
 *}
{extends file='parent:catalog/_partials/miniatures/brand.tpl'}

{block name='brand_miniature_item'}
  <article class="gucci-brand-card brand">
    <a href="{$brand.url}" class="gucci-brand-card__link" title="{$brand.name|escape:'htmlall':'UTF-8'}">
      {if $brand.image}
        <div class="gucci-brand-card__media">
          <picture>
      ...
      {/if}
      <div class="gucci-brand-card__body">
        <h2 class="gucci-brand-card__name">{$brand.name|escape:'htmlall':'UTF-8'}</h2>
        <p class="gucci-brand-card__count">
        ...
        <span class="gucci-brand-card__cta">

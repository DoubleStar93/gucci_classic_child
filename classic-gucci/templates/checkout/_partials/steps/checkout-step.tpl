{**
 * Classic Gucci — step checkout (titoli IT)
 *}
{assign var='gucciStepTitle' value=$title}
{if isset($language) && $language.iso_code == 'it'}
  {if $title == 'Personal Information'}{assign var='gucciStepTitle' value='Informazioni personali'}{/if}
  {if $title == 'Addresses'}{assign var='gucciStepTitle' value='Indirizzi'}{/if}
  {if $title == 'Shipping Method'}{assign var='gucciStepTitle' value='Spedizione'}{/if}
  {if $title == 'Payment'}{assign var='gucciStepTitle' value='Pagamento'}{/if}
{/if}

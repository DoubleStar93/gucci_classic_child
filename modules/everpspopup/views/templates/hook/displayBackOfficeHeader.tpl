{*
 * Unused by PHP (inline HTML from getBarbaraalvisiBoGlobalsHtml). Kept as reference.
 * window.* only — never redeclare ps_faviconnotificationbo with var/let.
 *}
<script data-ba-ever-bo-globals="1">
(function (w) {
